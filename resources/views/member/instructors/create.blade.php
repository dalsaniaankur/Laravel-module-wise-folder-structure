  ...
  <div class="row"> 
    ...
    <div class="col-md-9">
      ...
      @if(isset($instructor))
        ...
        'route' => ['member.instructor.save']]) !!}
         <input type="hidden" name="id" value="{{$instructor->instructor_id}}" />
      @else
          {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'instructor-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['member.instructor.save']]) !!}
      ...
      @endif
        <div class="tab-content ">
         ...
         <div class="form-navigation">
          	 <div class="form-group">
               <div class="col-sm-offset-3 col-sm-8"> 
               <a href="{{ route('member.instructors.index') }}" class="btn btn-primary">@lang('quickadmin.cancel')</a>
