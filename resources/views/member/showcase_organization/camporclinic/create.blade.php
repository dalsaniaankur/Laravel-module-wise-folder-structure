    ...
    <div class="col-md-9">
      <div class="nav-tabs-custom validation-tab" >
       ...
       @if(isset($campOrClinic->camp_clinic_id))
        ...
        'route' => ['member.camp_or_clinic.save']]) !!}
         <input type="hidden" name="id" value="{{$campOrClinic->camp_clinic_id}}" />

      @else
          {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'team-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['member.camp_or_clinic.save']]) !!}
      ...
      @endif
        <div class="tab-content ">
         ...
         <div class="form-navigation">
          	 <div class="form-group">
               <div class="col-sm-offset-3 col-sm-8"> 
               <a href="{{ route('member.camp_or_clinic.index') }}" class="btn btn-primary">@lang('quickadmin.cancel')</a>
