...
<section class="content-header">
  ...
  <p class="text-right"><a href="{{ route('member.camp_or_clinic.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a></p>
</section>
<!-- Main content -->
  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block">
       	 {!! Form::open(['method' => 'get','name'=>'camp-or-clinic-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['member.camp_or_clinic.index']]) !!}
        ...
        <div class="box-body">
          <table id="instructorsgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $campOrClinic->camp_clinic_id }}"> 
              ...
              <td> 
               <a href="{{ route('member.camp_or_clinic.edit',[$campOrClinic->camp_clinic_id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
               {!! Form::open(array(
                'style' => 'display: inline-block;',
                'method' => 'DELETE',
                'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                'route' => ['member.camp_or_clinic.destroy', $campOrClinic->camp_clinic_id])) !!}
