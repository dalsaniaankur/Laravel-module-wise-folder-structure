            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom validation-tab" >
                    ...
                    @if(isset($tournamentOrganization))
                        ...
                        'route' => ['member.tournament_organization.save']]) !!}
                        <input type="hidden" name="id" value="{{$tournamentOrganization->tournament_organization_id}}" />
                    @else
                        {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'team-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['member.tournament_organization.save']]) !!}
                    ...
                    <div class="tab-content ">
                        ...
                        <div class="form-navigation">
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    <a href="{{ route('member.tournament_organizations.index') }}" class="btn btn-primary">@lang('quickadmin.cancel')</a>
