...
<section class="content-header">
  ...
  <p class="text-right">
    <a href="{{ url('member/agegroup_position/create/'.$age_group_id.'/'.$tryout_id) }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
  </p>
  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block"> 
       	 ...
       	 {!! Form::open(['url' => 'member/agegroup_position/'.$age_group_id.'/'.$tryout_id, 'method' => 'get','name'=>'tournament_organization-form', 'class'=>'form-horizontal validation-form','data-parsley-validate']) !!}
        ...
        <div class="box-body">
          <table id="instructorsgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $data->agegroup_position_id }}"> 
              ...
              <td> 
               <a href="{{ url('member/agegroup_position/edit/'.$data->agegroup_position_id.'/'.$age_group_id.'/'.$tryout_id) }}" class="btn btn-xs btn-info">
               @lang('quickadmin.qa_edit')</a>
               {!! Form::open(array(
                'style' => 'display: inline-block;',
                'method' => 'DELETE',
                'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                'url' => 'member/agegroup_position/destroy/'.$data->agegroup_position_id.'/'.$age_group_id.'/'.$tryout_id
