        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom validation-tab" >
                    ...
                    <!-- form start -->
                    @if(isset($tournament))
                        {!! Form::model($tournament, ['method' => 'POST', 'enctype' => 'multipart/form-data', 'class'=>'form-horizontal validation-form','data-parsley-validate', 'url' => 'member/tournament/save/'.$tournament_organization_id ]) !!}

                        <input type="hidden" name="id" value="{{$tournament->tournament_id}}" />
                    @else
                        {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'team-form', 'class'=>'form-horizontal validation-form','data-parsley-validate', 'url' => 'member/tournament/save/'.$tournament_organization_id]) !!}
                    ...
                    <div class="tab-content ">
                        ...
                        <div class="form-navigation">
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    <a href="{{ url('member/tournament') }}/{{ $tournament_organization_id }} " class="btn btn-primary">@lang('quickadmin.cancel')</a>
