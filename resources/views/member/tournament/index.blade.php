...
<section class="content-header">
  ...
  <p class="text-right"><a href="{{ url('member/tournament/create/'.$tournament_organization_id) }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a></p>
</section>
<!-- Main content -->
  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block"> 
       	 ...
       	 {!! Form::open(['url' => 'member/tournament/'.$tournament_organization_id, 'method' => 'get','name'=>'tournament_organization-form', 'class'=>'form-horizontal validation-form','data-parsley-validate']) !!}
          <div class="input-group input-group-lg">
           {!! Form::text('search', old('search'), ['class' => 'form-control', 'placeholder' => 'Search Tournament','previous'=>'previous']) !!}           
        ...
        <div class="box-body">
          <table id="instructorsgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $data->tournament_id }}"> 
              ...
              <td> 
               <a href="{{ url('member/tournament/edit/'.$data->tournament_id.'/'.$tournament_organization_id) }}" class="btn btn-xs btn-info">
               ...
               {!! Form::open(array(
                ...
                'url' => 'member/tournament/destroy/'.$data->tournament_id.'/'.$tournament_organization_id
