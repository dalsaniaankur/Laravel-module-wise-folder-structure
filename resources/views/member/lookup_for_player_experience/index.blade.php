...
<section class="content-header">
  ...
  <p class="text-right"><a href="{{ route('member.lookup_for_player_experience.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a></p>
</section>
<!-- Main content -->
  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block">
       	 {!! Form::open(['method' => 'get','name'=>'lookup_for_player_experience-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['member.lookup_for_player_experience.index']]) !!}
        ...
        <div class="box-body">
          <table id="lookup_for_player_experiencegrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $lookup_for_player_experience->lookup_for_player_experience_id }}"> 
              ...
              <td> 
               <a href="{{ route('member.lookup_for_player_experience.edit',[$lookup_for_player_experience->lookup_for_player_experience_id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
               {!! Form::open(array(
                'style' => 'display: inline-block;',
                'method' => 'DELETE',
                'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                'route' => ['member.lookup_for_player_experience.destroy', $lookup_for_player_experience->lookup_for_player_experience_id])) !!}
