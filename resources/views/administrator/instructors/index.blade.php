...
<section class="content-header">
  ...
  @can('instructor_add')
  <p class="text-right"><a href="{{ route('administrator.instructors.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a></p>
  @endcan
</section>
<!-- Main content -->
  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block">
       	 {!! Form::open(['method' => 'get','name'=>'instructor-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.instructors.index']]) !!}
          <div class="input-group input-group-lg">
           {!! Form::text('search', old('search'), ['class' => 'form-control', 'id' => 'search', 'placeholder' => 'Search Instructor','previous'=>'previous']) !!}
        ...
        <div class="box-body">
          <table id="instructorsgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $instructor->instructor_id }}"> 
              ...
              <td>
               <a href="{{ url('administrator/instructors_duplicate/'.$instructor->instructor_id) }}" class="btn btn-xs btn-info"> @lang('quickadmin.qa_duplicate')</a>
               @can('instructor_edit')
               <a href="{{ route('administrator.instructors.edit',[$instructor->instructor_id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
               @endcan
               ...
               {!! Form::open(array(
                ...
                'route' => ['administrator.instructors.destroy', $instructor->instructor_id])) !!}
