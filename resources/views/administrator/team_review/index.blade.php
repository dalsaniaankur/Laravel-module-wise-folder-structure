  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block">
       	 {!! Form::open(['method' => 'get','name'=>'team_review-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.team_review.index']]) !!}
        ...
        <div class="box-body">
          <table id="team_reviewsgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $data->review_id }}"> 
              ...
              <td> 
               <a href="{{ route('administrator.team_review.edit',[$data->review_id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
              </td>
            </tr>
            @endforeach
            @else
