            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom validation-tab" >
                    ...
                    @if(isset($team))
                        ...
                        'route' => ['administrator.team_save.save']]) !!}
                        <input type="hidden" name="id" value="{{$team->team_id}}" />
                    @else
                        {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'team-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.team_save.save']]) !!}
                        <input type="hidden" name="id" value="" />
                    @endif

                    <div class="tab-content ">
                        <div class="tab-pane active" id="teamsInfo">
                            <div class="form-group"> {!! Form::label('submitted_by_id', trans('quickadmin.teams.fields.submitted_by_id') .': ', ['class' => 'col-sm-3 control-label']) !!}
                            ...
                            @if(isset($team->team_id))
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-8">
                                        <a href="{{url('administrator/tryout/'.$team->team_id)}}">
                        ...
                        <div class="tab-pane" id="extra_details">
                            ...
                            <div class="form-group">
                                {!! Form::label('approval_status', trans('quickadmin.teams.fields.approval_status') .': * ', ['class' => 'col-sm-3 control-label']) !!}
                                <div class="col-sm-8">
                        ...
                        <div class="form-navigation">
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    <a href="{{ route('administrator.teams.index') }}" class="btn btn-primary">@lang('quickadmin.cancel')</a>
