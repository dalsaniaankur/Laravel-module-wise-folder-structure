            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom validation-tab">
                    ...
                    @if(isset($ageGroup))
                        ...
                        'route' => ['administrator.showcase_age_group.save']]) !!}

                        <input type="hidden" name="id" value="{{$ageGroup->age_group_id}}" />

                    @else

                        {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'event-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.showcase_age_group.save']]) !!}
                            ...
                            <div class="form-navigation">
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-8">
                                        <a href="{{ route('administrator.showcase_age_groups.index') }}"
