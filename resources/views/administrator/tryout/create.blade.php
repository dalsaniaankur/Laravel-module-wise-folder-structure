        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom validation-tab" >
                    ...
                    <!-- form start -->
                    @if(isset($tryout))
                        {!! Form::model($tryout, ['method' => 'POST', 'enctype' => 'multipart/form-data', 'class'=>'form-horizontal validation-form','data-parsley-validate', 'url' => 'administrator/tryout/save/'.$team_id ]) !!}
                        <input type="hidden" name="id" value="{{$tryout->tryout_id}}" />
                    @else
                        {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'team-form', 'class'=>'form-horizontal validation-form','data-parsley-validate', 'url' => 'administrator/tryout/save/'.$team_id]) !!}
                        <input type="hidden" name="id" value="" />
                    @endif

                    <div class="tab-content ">
                        <div class="tab-pane active" id="teamsInfo">
                            <div class="form-group"> {!! Form::label('submitted_by_id', trans('quickadmin.tryout.fields.submitted_by_id') .': ', ['class' => 'col-sm-3 control-label']) !!}
                        ...
                        <div class="form-navigation">
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    <a href="{{ url('administrator/tryout') }}/{{ $team_id}} " class="btn btn-primary">@lang('quickadmin.cancel')</a>
