  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block"> 
       	 ...
       	 {!! Form::open(['url' => 'administrator/agegroup/'.$tryout_id, 'method' => 'get','name'=>'tournament_organization-form', 'class'=>'form-horizontal validation-form','data-parsley-validate']) !!}
        ...
        <div class="box-body">
          <table id="instructorsgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $data->age_group_id }}"> 
              ...
              <td> 
                @can('tryout_agegroup_positions')
               <a href="{{url('administrator/agegroup_position/'.$data->age_group_id.'/'.$tryout_id)}}" class="btn btn-xs btn-info">@lang('quickadmin.tryout-age_group.position')</a>
               @endcan
              </td>
            </tr>
            @endforeach
