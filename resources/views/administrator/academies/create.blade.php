  ...
  <div class="row"> 
    ...
    <div class="col-md-9">
      <div class="nav-tabs-custom validation-tab" >
        ...
        'route' => ['administrator.academy.save']]) !!}
        <input type="hidden" name="id" value="{{$academies->academy_id}}" />
        @else
        
        {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'academies-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.academy.save']]) !!}
        <input type="hidden" name="id" value="" />
        @endif

        <div class="tab-content ">
          <div class="tab-pane active" id="academy_info">
            <div class="form-group"> {!! Form::label('member_id', trans('quickadmin.academy.fields.member_id') .': ', ['class' => 'col-sm-3 control-label']) !!}
              <div class="col-sm-8"> {!! Form::select('member_id', $member, old('member_id'), ['class' => 'form-control']) !!}
          ...
          <div class="tab-pane" id="extra_details">
            ...
            <div class="form-group">
              {!! Form::label('approval_status', trans('quickadmin.academy.fields.approval_status') .': * ', ['class' => 'col-sm-3 control-label']) !!}
              <div class="col-sm-8">
          ...
          <div class="form-navigation">
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-8"> <a href="{{ route('administrator.academies.index') }}" class="btn btn-primary">@lang('quickadmin.cancel')</a> {!! Form::submit(trans('quickadmin.qa_save'), ['class' => 'btn btn-danger']) !!}
