...
<section class="content-header">
  ...
  @can('coaches_needed_add')
  <p class="text-right"><a href="{{ route('administrator.coaches_needed.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a></p>
   @endcan
</section>
<!-- Main content -->
  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block">
       	 {!! Form::open(['method' => 'get','name'=>'coaches_needed-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.coaches_needed.index']]) !!}
        ...
        <div class="box-body">
          <table id="coaches_neededgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $coaches_needed->coaches_needed_id }}"> 
              ...
              <td>
                <a href="{{ url('administrator/coaches_needed_duplicate/'.$coaches_needed->coaches_needed_id) }}" class="btn btn-xs btn-info"> @lang('quickadmin.qa_duplicate')</a>
                @can('coaches_needed_edit')
               <a href="{{ route('administrator.coaches_needed.edit',[$coaches_needed->coaches_needed_id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
               @endcan
               @can('coaches_needed_delete') 
               {!! Form::open(array(
                'style' => 'display: inline-block;',
                'method' => 'DELETE',
                'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                'route' => ['administrator.coaches_needed.destroy', $coaches_needed->coaches_needed_id])) !!}
