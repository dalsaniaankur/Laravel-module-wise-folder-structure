...
<section class="content-header">
  ...
  @can('showcase_or_prospect_add')
  <p class="text-right"><a href="{{ route('administrator.showcase_or_prospect.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a></p>
  @endcan
</section>
<!-- Main content -->
  ...
  <div class="row">
   ...
   <div class="content-header-with-cell">
      <div class="custom-search-block">
       	 {!! Form::open(['method' => 'get','name'=>'camp-or-clinic-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.showcase_or_prospect.index']]) !!}
          <div class="input-group input-group-lg">
           {!! Form::text('search', old('search'), ['id' => 'search', 'class' => 'form-control', 'placeholder' => 'Search Showcase  Or Prospect','previous'=>'previous'	]) !!}
        ...
        <div class="box-body">
          <table id="instructorsgrid" class="table table-bordered table-striped">
            ...
            <tr data-entry-id="{{ $showcaseOrProspect->showcase_or_prospect_id }}"> 
              ...
              <td>
                <a href="{{ url('administrator/showcase_or_prospect_duplicate/'.$showcaseOrProspect->showcase_or_prospect_id) }}" class="btn btn-xs btn-info"> @lang('quickadmin.qa_duplicate')</a>
              @can('showcase_or_prospect_edit')
               <a href="{{ route('administrator.showcase_or_prospect.edit',[$showcaseOrProspect->showcase_or_prospect_id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
              @endcan
              
              @can('showcase_or_prospect_delete') 
               {!! Form::open(array(
                'style' => 'display: inline-block;',
                'method' => 'DELETE',
                'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                'route' => ['administrator.showcase_or_prospect.destroy', $showcaseOrProspect->showcase_or_prospect_id])) !!}
