    ...
    <div class="col-md-9">
      <div class="nav-tabs-custom validation-tab" >
       ...
       @if(isset($showcaseOrProspect->showcase_or_prospect_id))
        ...
        'route' => ['administrator.showcase_or_prospect.save']]) !!}
         <input type="hidden" name="id" value="{{ $showcaseOrProspect->showcase_or_prospect_id }}" />
      @else
          {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'team-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.showcase_or_prospect.save']]) !!}
         <input type="hidden" name="id" value="" />
      @endif
        <div class="tab-content ">
         <div class="tab-pane active" id="teamsInfo">
              <div class="form-group"> 
                {!! Form::label('submitted_by_id', trans('quickadmin.showcase_or_prospect.fields.submitted_by_id') .': * ', ['class' => 'col-sm-3 control-label']) !!}
                ...
                <div class="col-sm-8">
                    @foreach ($types as $key => $value)
                      ...
                      @if($showcaseOrProspect->type == $key)
                        @php ($is_checked = true)
                      @endif
                      {!! Form::radio('type', $key, $is_checked, array('id' => 'type_'.$key)) !!}
         ...
         <div class="tab-pane" id="extra_details">
          ...
          @endif
             ...
             <div class="form-group">
                 {!! Form::label('approval_status', trans('quickadmin.showcase_or_prospect.fields.approval_status') .': * ', ['class' => 'col-sm-3 control-label']) !!}
                 <div class="col-sm-8">
         ...
         <div class="form-navigation">
          	 <div class="form-group">
               <div class="col-sm-offset-3 col-sm-8"> 
               <a href="{{ route('administrator.showcase_or_prospect.index') }}" class="btn btn-primary">@lang('quickadmin.cancel')</a>
