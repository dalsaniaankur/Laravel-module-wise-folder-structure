  ...
  <div class="row"> 
    ...
    <div class="col-md-9">
      ...
      @if(isset($lookup_for_player_experience))
        ...
        'route' => ['administrator.lookup_for_player_experience.save']]) !!}

         <input type="hidden" name="id" value="{{$lookup_for_player_experience->lookup_for_player_experience_id}}" />

      @else
        
          {!! Form::open(['method' => 'POST', 'enctype' => 'multipart/form-data', 'name'=>'lookup_for_player_experience-form', 'class'=>'form-horizontal validation-form','data-parsley-validate','route' => ['administrator.lookup_for_player_experience.save']]) !!}
      ...
      @endif
        ...
        <div class="tab-content ">
         <div class="tab-pane active" id="lookup_for_player_experience_info">
              ...
              <div class="form-group"> {!! Form::label('member_id', trans('quickadmin.lookup_for_player_experience.fields.member_id') .': ', ['class' => 'col-sm-3 control-label']) !!}
         ...
         <div class="form-navigation">
          	 <div class="form-group">
               <div class="col-sm-offset-3 col-sm-8"> 
               <a href="{{ route('administrator.lookup_for_player_experience.index') }}" class="btn btn-primary">@lang('quickadmin.cancel')</a>
