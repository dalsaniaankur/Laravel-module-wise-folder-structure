            ...
            if ($lastpage < 7 + ($adjacents * 2)) {
                ...
                if ($this->_page < 1 + ($adjacents * 2)) {
                    ...
                    for ($counter = $this->_page - $adjacents; $counter <= $this->_page + $adjacents; $counter++) {
                        if ($counter == $this->_page)
                            $pagination .= "<span class='page-link active'>$counter</span>";
                        else
                            $pagination .= "<li class='page-item'><a class='page-link' href='" . $path . "$this->_instance=$counter" . "$ext'>$counter</a></li>";
                    }
                    $pagination .= "..";
                    ...
                    $pagination .= "<li class='page-item'><a href='" . $path . "$this->_instance=1" . "$ext'>1</a></li>";
                    $pagination .= "<li class='page-item'><a href='" . $path . "$this->_instance=2" . "$ext'>2</a></li>";
                    $pagination .= "..";
