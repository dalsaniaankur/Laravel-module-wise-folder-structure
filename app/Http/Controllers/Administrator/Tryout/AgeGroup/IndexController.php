<?php
namespace App\Http\Controllers\Administrator\Tryout\AgeGroup;
...
class IndexController extends Controller{
    ...
    public function index(Request $request, $tryout_id){
        ...
        if (!Gate::allows('tryout_agegroup')){ return abort(404); }
        ...
        return view('administrator.tryout.agegroup.index',compact('agegroup','paging','tryout_id','tryout_name','team_name'));
    }
}